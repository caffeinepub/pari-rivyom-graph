...
export class Backend implements backendInterface {
    ...
    async addPoint(arg0: string, arg1: number, arg2: number): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addPoint(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addRegion(arg0: string, arg1: number, arg2: number, arg3: number, arg4: number): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addRegion(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deletePoint(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deletePoint(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteRegion(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getPoints(): Promise<Array<Point>> {
        if (this.processError) {
            try {
    ...
    async getRegions(): Promise<Array<Region>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRegions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
